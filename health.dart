...
class _HealthState extends State<Health> {
  ...
  Future<void> fetchData() async {
    ...
    Future vaccinations = Firestore.instance.collection("users")
        .document(MyPoultry.sharedPreferences.getString(MyPoultry.userUID))
        .collection("vaccines").getDocuments();
    Future medication = Firestore.instance.collection("users")
        .document(MyPoultry.sharedPreferences.getString(MyPoultry.userUID))
        .collection("medication").getDocuments();
