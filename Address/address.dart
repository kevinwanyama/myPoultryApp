...
class Address extends StatefulWidget
{
  ...
  const Address({Key key, this.totalAmount, this.product}) : super(key: key);
...
class AddressCard extends StatefulWidget {
  ...
  AddressCard({Key key, this.product, this.model, this.totalAmount, this.value, this.addressId, this.currentIndex}) : super(key: key);
