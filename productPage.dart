            ...
            Padding(
              ...
              child: Container(
                ...
                child: RaisedButton.icon(
                  ...
                  label: Text("Check Out", style: GoogleFonts.fredokaOne(color: Colors.white,),),
                  elevation: 5.0,
                ),
              ),
            ),
            Padding(
              ...
              child: Container(
                ...
                child: RaisedButton.icon(
                  ...
                  label: Text("Call", style: GoogleFonts.fredokaOne(color: Colors.black,),),
            ...
            Padding(
              ...
              child: Container(
                ...
                child: RaisedButton.icon(
                  ...
                  label: Text("Chat", style: GoogleFonts.fredokaOne(color: Colors.black,),),
                  elevation: 5.0,
                ),
              ),
            ),
